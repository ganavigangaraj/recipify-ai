export default function IngredientComponent(props){
    ...
    return(
        ...
        <section>
                <h2 className="pt-2 text-xl  font-medium text-white">Ingredients on hand:</h2>
                <ul className="mb-12 leading-7 pl-3 text-white" aria-live="polite">{ingredientsListItems}</ul>
